...
//                System.out.println(item.template.name + " (x" + item.quantityGD + "),");
        ...
        try {
            String sql = String.format("INSERT INTO history_transaction VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
      player1, player2, itemPlayer1, itemPlayer2, beforeTran1, beforeTran2, afterTran1, afterTran2, new Timestamp(System.currentTimeMillis()));
